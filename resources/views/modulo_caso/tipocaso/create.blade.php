        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Nuevo Tipo Caso</h3>
                </div>
                <form role="form" action="{{ route('tipocaso.index') }}" method="POST">
                    @csrf
                    <div class="box-body">
                        @if ($errors->any())
                    ...
                    <div class="box-footer">
                        <div class="col-xs-6">
                            <a href="{{ route('tipocaso.index') }}" class="btn btn-default btn-block">Cancel</a>
                        </div>
                        <div class="col-xs-6">
